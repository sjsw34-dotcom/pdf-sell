...
chapter: 3
takeaways:
  - Your birth chart has four pillars — Year, Month, Day, and Hour — each with a Heavenly Stem and an Earthly Branch
  - The 10 Heavenly Stems represent the Yin and Yang expressions of the Five Elements
  - The 12 Earthly Branches carry animal associations and contain Hidden Stems that add depth
  - The Sexagenary Cycle of 60 Stem-Branch pairs is the engine behind the entire Saju calendar
  - You can set up a basic chart using your birth date, time, and an online calculator
exercise: Go to sajumuse.com/free-reading, enter your birth details, and generate your chart. Write down all eight characters — four Heavenly Stems and four Earthly Branches. Identify which element and polarity each one belongs to using the reference tables in this chapter.
cta: Want a certified master to interpret YOUR Four Pillars? → Get your personalized reading at sajumuse.com
---
...
Eight characters in total. Four on top (the Heavenly Stems), four on the bottom (the Earthly Branches). This simple grid contains everything a Saju master needs to read your life.
...
|---|---|---|---|
| Year Pillar | Social identity, ancestry | Early childhood | Grandparents, society |
| Month Pillar | Career, ambition | Youth to early adulthood | Parents, career |
...
| 3 | 丙 | Byeong | Fire | Yang | The sun — radiant, warm, visible to all |
| 4 | 丁 | Jeong | Fire | Yin | The candle — focused, intimate, precise |
| 5 | 戊 | Mu | Earth | Yang | The mountain — stable, grounded, immovable |
| 6 | 己 | Gi | Earth | Yin | The garden soil — nurturing, fertile, accommodating |
| 7 | 庚 | Gyeong | Metal | Yang | The sword — sharp, decisive, reforming |
| 8 | 辛 | Sin | Metal | Yin | The jewel — refined, sensitive, valuable |
| 9 | 壬 | Im | Water | Yang | The ocean — vast, deep, unstoppable |
| 10 | 癸 | Gye | Water | Yin | The rain — gentle, nourishing, perceptive |

Notice how each pair shares the same element but has completely different character. Yang Wood (甲) is the oak tree that stands tall in a storm. Yin Wood (乙) is the ivy that bends around obstacles. Same energy, different strategy.
...
| 3 | 寅 | In | Tiger | Wood | Yang |
| 4 | 卯 | Myo | Rabbit | Wood | Yin |
| 5 | 辰 | Jin | Dragon | Earth | Yang |
| 6 | 巳 | Sa | Snake | Fire | Yin |
| 7 | 午 | O | Horse | Fire | Yang |
| 8 | 未 | Mi | Goat | Earth | Yin |
| 9 | 申 | Sin | Monkey | Metal | Yang |
| 10 | 酉 | Yu | Rooster | Metal | Yin |
| 11 | 戌 | Sul | Dog | Earth | Yang |
| 12 | 亥 | Hae | Pig | Water | Yin |

You probably recognize the twelve animals from the Chinese zodiac. In Saju, the animals are a helpful mnemonic, but the real interpretive power lies in the element each branch carries and the Hidden Stems it contains.
...
|---|---|---|---|
| 子 | Rat | 癸 | Pure Water |
| 丑 | Ox | 癸, 辛, 己 | Water + Metal + Earth |
| 寅 | Tiger | 甲, 丙, 戊 | Wood + Fire + Earth |
| 卯 | Rabbit | 乙 | Pure Wood |
