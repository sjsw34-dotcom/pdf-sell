...
chapter: 25
takeaways:
  - The Five Elements map directly to organ systems in traditional East Asian medicine — Wood governs liver and gallbladder, Fire governs heart, Earth governs spleen and stomach, Metal governs lungs, and Water governs kidneys and bladder
  - Missing or deficient elements in your natal chart indicate potential areas of health vulnerability, while excess elements suggest systems that may be over-stimulated or strained
  - A weak Day Master means the organ system associated with that element is fundamentally under-resourced — this is often the primary health concern in traditional Saju health reading
  - Fortune cycles can shift your elemental balance over time, creating decades of improved vitality when supportive elements arrive and periods requiring greater health awareness when unfavorable elements dominate
  - Saju health reading is a tool for awareness and preventive wellness — it is NOT medical diagnosis, and it should always complement, never replace, professional healthcare
exercise: "Count your Five Elements. Which element is most deficient? Check the health association table — does this correlate with any health tendencies you have experienced? Remember: Saju is for awareness, not diagnosis."
cta: Want a health-focused element analysis for YOUR chart? → Get your personalized reading at sajumuse.com
---

# Chapter 25: Health Reading

Every system of traditional medicine in East Asia begins with the same foundation that Saju uses: the Five Elements. This is not a coincidence. For thousands of years, Korean, Chinese, and Japanese healers have understood the human body as a miniature ecosystem of Wood, Fire, Earth, Metal, and Water. When these elements flow in balance, health is stable. When one element is deficient or excessive, specific organ systems come under strain.
...
The connection between the Five Elements and human health is one of the oldest ideas in East Asian philosophy. It predates Saju itself. Traditional Korean medicine (*Hanbang*), Traditional Chinese Medicine (TCM), and Japanese Kampo medicine all share the same elemental framework for understanding the body. When Saju practitioners read health from a chart, they are drawing on this shared foundation.

Each of the Five Elements governs a pair of organs — one Yin organ and one Yang organ — along with associated body areas, sensory organs, and tissues.

### The Five Elements Health Map

| Element | Yin Organ | Yang Organ | Body Area | Sense Organ | Tissue |
|---|---|---|---|---|---|
...
## 25.2 Element Deficiency and Health Vulnerability
...
- Eyes may tire easily; tendency toward eye strain or dryness
- Tendons and ligaments may be more prone to stiffness or injury
- Emotional association: difficulty processing anger or frustration (which traditional medicine links to the liver)

**No Fire (0 Fire)**
- Heart and circulatory system may need extra attention
- Blood pressure regulation could be a focus area
- Tendency toward cold extremities or poor circulation
- Emotional association: difficulty with joy and enthusiasm (the heart's emotion in traditional medicine)

**No Earth (0 Earth)**
- Digestive system may be sensitive — stomach issues, bloating, food intolerances
- Muscles may lack tone or recover slowly from exertion
- Tendency toward worry or overthinking (Earth's associated emotion)
- Appetite and weight management may fluctuate

**No Metal (0 Metal)**
- Respiratory system may be vulnerable — susceptibility to colds, allergies, or sinus issues
- Skin may be sensitive, dry, or reactive
- Large intestine function may need dietary support
- Emotional association: difficulty letting go or processing grief

**No Water (0 Water)**
- Kidneys and bladder may be areas of vulnerability
- Bone density and joint health may need attention over time
- Reproductive health may require more awareness
- Emotional association: fear or anxiety (Water's associated emotion)
- Energy and stamina may deplete faster than average

### Weak Day Master: The Central Vulnerability

Your Day Master element is not just one element among five. It represents *you* — your core vitality, your fundamental constitution. When the Day Master is weak (few supporting elements in the chart), traditional interpretation suggests that the organ system of the Day Master's element is the primary area requiring lifelong attention.

Think of it this way: if a missing element is like an empty garden bed, a weak Day Master is like the central irrigation pump running at low pressure. Everything downstream is affected.

A person with a weak Water Day Master, for instance, may find that kidney health, bone density, and energy levels are recurring themes throughout life — not because they are "fated" to be unwell, but because their elemental constitution allocates less baseline energy to these systems.

This is where Saju health reading becomes genuinely useful. Awareness of a constitutional tendency allows for proactive choices: staying hydrated, supporting kidney health through diet, prioritizing bone-strengthening exercise, and being more attentive to fatigue signals.

### Excess Elements: Too Much of a Good Thing
...
## 25.3 Fortune Cycles and Health Timing

Your natal chart sets the constitutional baseline. But as you learned in Chapters 19 through 21, fortune cycles bring new elements into your life every decade and every year. These incoming elements change your elemental balance — and with it, your health landscape.

### Grand Fortune and Long-Term Health Patterns

Grand Fortune (Daeun) cycles last approximately ten years each. When a Grand Fortune decade brings an element that your chart desperately needs, traditional interpretation suggests a period of improved vitality and resilience. When a decade brings an element that is already excessive or is classified as Unfavorable for your chart, it may coincide with a period where health requires more conscious attention.
...
|---|---|---|
| Brings Useful God element | Supportive | Period of improved vitality; body receives what it has been lacking |
| Brings Favorable element | Mildly supportive | Generally positive; a "good weather" decade for health |
| Brings neutral element | Neutral | Health neither significantly helped nor challenged |
| Brings Unfavorable element | Challenging | Greater awareness needed; the body may be under more strain |
| Brings Hostile element | Most challenging | Prioritize preventive care; be attentive to the organ systems associated with excess |

### Annual Fortune and Health Flashpoints
...
Now let us apply everything from this chapter to a complete health reading. We will use Chart C, which is one of the most instructive charts for health analysis because of its extreme elemental imbalance.
...
| Fire | 4 | **Heavily excess** |
| Earth | 3 | **Excess** |
| Metal | 0 | **Completely absent** |
| Water | 1 | **Severely deficient** (Day Master only) |

This is a striking chart. Two elements are completely absent. Two elements are in significant excess. And the Day Master's own element — Water — appears only once, in the Day Master stem itself, with no support from any other position.
...
|---|---|---|---|
| 1-10 | 庚午 | Metal + Fire | Metal (Favorable) arrives but paired with more Fire (Hostile). Mixed — some kidney support via Metal, but Fire excess increases |
| 11-20 | 辛未 | Metal + Earth | Metal continues (good for Water generation) but Earth (Unfavorable) adds pressure. Adolescence may bring digestive or skin sensitivities |
| **21-30** | **壬申** | **Water + Metal** | **Breakthrough decade.** Both the Useful God (Water) and Favorable element (Metal) arrive simultaneously. This is the most health-supportive decade in Chart C's life. Energy levels rise, kidney and bone systems receive direct support, and the overall elemental balance improves dramatically |
| **31-40** | **癸酉** | **Water + Metal** | **Continued support.** Another decade of Water + Metal. The Day Master is reinforced by its own element plus its "parent." This is likely Chart C's best health decade — peak vitality and resilience |
| 41-50 | 甲戌 | Wood + Earth | A significant shift. Wood (which was absent) finally arrives — good news for the liver system. But Earth (Unfavorable) returns in the branch, adding pressure to the Day Master. The output of Wood also drains the already-weak Water. Health challenges from the natal chart may resurface. This decade calls for increased health vigilance |
