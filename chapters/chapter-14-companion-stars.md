...
chapter: 14
takeaways:
  - The Companion Stars represent the self extended — siblings, peers, allies, competitors, and the strength of identity
  - The Friend (비견) is the equal partner — same element, same polarity, shared values and mutual support
  - Rob Wealth (겁재) is the competitive ally — same element, different polarity, driving ambition through rivalry
  - Companion Stars strengthen the Day Master directly, which is crucial for weak Day Masters under pressure
  - When Companions are absent, the person stands alone — self-reliant but isolated, with no one who truly understands them
exercise: Count your Companion Stars (Friend and Rob Wealth) in your chart. Think about your relationship with siblings, close peers, and competitors. Do you have natural allies in life, or do you tend to stand alone? Does the count match your experience?
cta: Want to understand YOUR relationship with peers and self-identity? → Get your personalized reading at sajumuse.com
---

We have covered what you create (Output), what you acquire (Wealth), what governs you (Authority), and what supports you (Resource). Now we arrive at the most fundamental pair: what *is* you — extended outward into the world.

The Companion Stars are the elements that share your Day Master's identity. They are the same element — your element — appearing elsewhere in the chart. When you encounter a Companion Star, you encounter a reflection of yourself: an ally, a sibling, a competitor, or a mirror.

## The Two Faces of Companionship

| Companion Star | Polarity | Korean | Character |
|---|---|---|---|
| **Friend** | Same as Day Master | 비견 比肩 | Equal, supportive, shared identity |
| **Rob Wealth** | Different from Day Master | 겁재 劫財 | Competitive, driving, ambitious rivalry |

The character 比 (*bi*) means "to compare" and 肩 (*gyeon*) means "shoulder" — the Friend stands shoulder to shoulder with you. The character 劫 (*geop*) means "to rob" and 財 (*jae*) means "wealth" — Rob Wealth competes for the same resources. One stands beside you; the other pushes you forward.
...
| Dimension | Friend (비견) | Rob Wealth (겁재) |
|---|---|---|
| **Relationship** | Equal, supportive, harmonious | Competitive, driving, ambitious |
| **Social dynamic** | Collaboration | Rivalry |
| **Financial effect** | Sharing | Competing |
| **Motivation source** | Mutual understanding | Mutual challenge |
| **Sibling type** | Same-gender sibling | Opposite-gender sibling |
| **When balanced** | Strong identity, reliable support | Healthy ambition, growth through challenge |
| **When excessive** | Echo chamber, stagnation | Financial loss, destructive competition |
| **When absent** | Isolation, weak identity | No competitive push, complacency risk |
...
|---|---|---|
| **Friend (비견)** | 卯 (Day Branch = Friend) | 0 |
| **Rob Wealth (겁재)** | 甲 (Hour Stem) | 0 |
| **Total Companions** | **2** | **0** |
...
- Month: 甲/寅 (Rob Wealth / Rob Wealth)
- Year: 癸/酉 (Indirect Seal / Indirect Officer)
...
|---|---|---|---|
| **Companion** (비겁) | Self, identity, peers | Strength, support, confidence | Wealth (competition) |
| **Output** (식상) | Creation, expression | Talent, children, visibility | Day Master energy (drain) |
| **Wealth** (재성) | Money, achievement | Material success, practical results | Day Master energy (control effort) |
