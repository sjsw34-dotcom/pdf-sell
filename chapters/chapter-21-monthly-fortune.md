...
chapter: 21
takeaways:
  - Monthly Fortune (Wolun) divides each year into twelve distinct elemental phases, making it the finest grain of regular timing in Saju — your tactical calendar for when to act and when to wait
  - Each month carries its own Stem-Branch pair that interacts with your natal chart, the current Grand Fortune, and the Annual Fortune simultaneously — creating a layered energy environment unique to you
  - The Ten God produced by the monthly stem tells you what kind of energy dominates that month (wealth, authority, output, resource, or companion), while the branch element reveals whether the month supports or challenges your Day Master
  - Life Stage assignments for each month show energy momentum — Peak months carry maximum force for action, while Extinction months signal the need to pause and recharge
  - Strategic timing awareness means aligning major decisions with favorable months and using challenging months for rest, reflection, and preparation
exercise: "Find the current month's Heavenly Stem and Earthly Branch. What Ten God does the stem create for your Day Master? Is the branch element supportive or challenging? Now check next month — is the shift favorable or unfavorable? Use this simple check to plan your month with greater awareness."
cta: Want a month-by-month fortune forecast for YOUR year? → Get your personalized reading at sajumuse.com
---

# Chapter 21: Monthly Fortune
...
Conversely, a challenging month within an otherwise favorable year is not a disaster. It is a temporary headwind. You adjust your sails and wait for the next month's shift. This is the practical power of Monthly Fortune: it gives you *granularity*.

## 21.2 How Monthly Fortune Works

Each month's Stem-Branch pair is determined by the sexagenary cycle, following a fixed sequence. The monthly stems cycle through the ten Heavenly Stems, while the monthly branches follow the twelve Earthly Branches in order, beginning with the Tiger branch in the first month of each year.
...
|---|---|---|
| Month 1 (January) | Early February | Tiger |
| Month 2 (February) | Early March | Rabbit |
| Month 3 (March) | Early April | Dragon |
| Month 4 (April) | Early May | Snake |
| Month 5 (May) | Early June | Horse |
| Month 6 (June) | Early July | Goat |
| Month 7 (July) | Early August | Monkey |
| Month 8 (August) | Early September | Rooster |
| Month 9 (September) | Early October | Dog |
| Month 10 (October) | Early November | Pig |
...
## 21.3 The Monthly Cycle Within a Year

To see how Monthly Fortune works in practice, let us map an entire year for a single chart. We will use Chart E, whom you have seen in earlier chapters.
...
### Chart E's 2026 Monthly Fortune — Complete Table

| Month | Stem | Stem God | Branch | Branch God | Life Stage | Energy Assessment |
|---|---|---|---|---|---|---|
| Jan |己 Yin Earth | Rob Wealth | 丑 Ox | Rob Wealth | Nurture | Idle — Earth on Earth, quiet buildup |
| Feb | 庚 Yang Metal | Eating God | 寅 Tiger | Ind. Officer | Birth | Mixed — Hostile stem, Favorable branch |
| Mar | 辛 Yin Metal | Hurting Officer | 卯 Rabbit | Dir. Officer | Bathing | Mixed — Hostile stem, Favorable branch |
| Apr | 壬 Yang Water | Ind. Wealth | 辰 Dragon | Friend | Crown | Challenging — Unfavorable stem, Idle branch |
| May | 癸 Yin Water | Dir. Wealth | 巳 Snake | Ind. Seal | Prime | Split — Unfavorable stem, Useful branch |
| Jun | 甲 Yang Wood | Ind. Officer | 午 Horse | Dir. Seal | Peak | **Strongest** — Favorable stem, Useful branch |
| Jul | 乙 Yin Wood | Dir. Officer | 未 Goat | Rob Wealth | Decline | Good stem, Idle branch — momentum fading |
| Aug | 丙 Yang Fire | Ind. Seal | 申 Monkey | Eating God | Sickness | Split — Useful stem, Hostile branch |
| Sep | 丁 Yin Fire | Dir. Seal | 酉 Rooster | Hurting Officer | Death | Split — Useful stem, Hostile branch |
| Oct | 戊 Yang Earth | Friend | 戌 Dog | Friend | Tomb | Idle — Earth on Earth, energy stored |
| Nov | 己 Yin Earth | Rob Wealth | 亥 Pig | Ind. Wealth | Extinction | **Most challenging** — Unfavorable branch, lowest energy |
| Dec | 庚 Yang Metal | Eating God | 子 Rat | Dir. Wealth | Conception | Difficult — Hostile stem, Unfavorable branch |
...
**July through December** — energy descends from Decline through Sickness, Death, Tomb, Extinction, and finally Conception. This is the descending half, where energy withdraws, consolidates, and prepares for the next cycle.

This arc is not random. It reflects the natural flow of the Day Master's energy through the twelve branches of the year. Every Day Master experiences this rise and fall, though the specific months of peak and trough differ depending on the Day Master element.

For Chart E's Yang Earth Day Master, June (Horse branch, Fire element) represents Peak energy. This makes intuitive sense: Fire produces Earth in the productive cycle, so the Fire branch of summer is where Earth energy reaches maximum strength.

## 21.4 Reading Specific Months

Let us now walk through the art of reading individual months. We will examine four months from Chart E's 2026 table — two favorable, two challenging — to demonstrate the interpretive method.
...
The stem carries Yin Water — Chart E's Unfavorable element. Water controls Fire, which means the stem energy undermines the Useful God. At a surface level, this looks problematic.
...
The stem is Yang Metal — Chart E's Hostile element. Metal drains Earth (the Day Master produces Metal in the productive cycle, losing energy in the process). The Eating God Ten God reinforces this: output energy flows away from the Day Master.

But the branch is the Tiger, carrying Wood — Chart E's Favorable element. Wood controls Earth (creating pressure), but in Chart E's case, Wood is classified as Favorable because it feeds Fire (the Useful God). The presence of Wood in the environment keeps the productive chain alive: Wood feeds Fire, Fire feeds Earth.
...
Feb ██░░░░░░░░ New energy begins (Birth)
Mar ███░░░░░░░ Growing, cleansing (Bathing)
Apr ████░░░░░░ Identity forming, caution needed (Crown)
May █████░░░░░ Strong foundation, navigate surface (Prime)
Jun ██████████ PEAK — Maximum alignment ★
Jul ███████░░░ Follow through, maintain (Decline)
Aug █████░░░░░ Reflect, absorb (Sickness)
Sep ████░░░░░░ Quiet wisdom, withdraw (Death)
Oct ███░░░░░░░ Consolidate, store (Tomb)
Nov █░░░░░░░░░ REST — Lowest point ▼
Dec ░░░░░░░░░░ New seed conceived (Conception)
```
