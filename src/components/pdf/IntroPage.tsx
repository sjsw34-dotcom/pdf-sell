...
const TOC: Record<TierCode, { part: string; title: string }[]> = {
  ...
  full: [
    { part: '1', title: 'Your Destiny Chart — The Four Pillars' },
    { part: '2', title: 'Elemental Balance & Yongsin' },
    { part: '3', title: 'Personality & Core Strengths' },
    { part: '4', title: 'Love & Marriage Fortune' },
    { part: '5', title: 'Wealth & Career Destiny' },
    { part: '6', title: 'Health & Constitution' },
    { part: '7', title: 'Spirit Stars & Hidden Influences' },
    { part: '8', title: 'Major Luck Cycles (Daeun)' },
  ],
  premium: [
    { part: '1', title: 'Your Destiny Chart — The Four Pillars' },
    { part: '2', title: 'Elemental Balance & Yongsin' },
    ...
    { part: '7', title: 'Spirit Stars & Hidden Influences' },
    { part: '8', title: 'Major Luck Cycles (Daeun)' },
    { part: '9', title: 'Annual Fortune Forecast' },
    { part: '10', title: 'Monthly Fortune Details' },
  ],
};
