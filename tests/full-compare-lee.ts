...
fs.writeFileSync('tests/result-lee-code.json', JSON.stringify(result, null, 2), 'utf-8');
...
const expert = {
  ...
  yinyang: {
    data: [["陰 : 4","陽 : 4","木 : 0","火 : 1","土 : 4","金 : 3","水 : 0","일간","비겁 : 3","식상 : 3","재성 : 0","관성: 0","인성 : 1"]]
  },
  shinsal: {
    data: [
  ...
  nyunun: {
    data: [
      ["2035","55 세","편관","乙","卯","편관","병","(건록)","甲 정관","-","乙 편관","육해살","재살","문곡귀인","눌삼재","원진(Year)","현침살","도화살","천문성"],
  ...
  wolun: {
    data: [
      ["12월","상관","庚","子","편재","절","(사)","壬 정재","-","癸 편재","장성살","육해살","천을귀인","천덕귀인","월덕귀인","도화살","-","-"],
      ["11월","비견","己","亥","정재","태","(태)","戊 겁재","甲 정관","壬 정재","망신살","역마살","관귀학관","역마살","천문성","-","-","-"],
      ["10월","겁재","戊","戌","겁재","양","(묘)","辛 식신","丁 편인","戊 겁재","월살","반안살","태극귀인","괴강살","천문성","명예살","-","-"],
      ["9월","편인","丁","酉","식신","장생","(장생)","庚 상관","-","辛 식신","년살","장성살","문창귀인","천주귀인","학당귀인","도화살","-","-"],
      ["8월","정인","丙","申","상관","목욕","(병)","戊 겁재","壬 정재","庚 상관","지살","망신살","천을귀인","금여","현침살","역마살","-","-"],
      ["7월","편관","乙","未","비견","관대","(양)","丁 편인","乙 편관","己 비견","천살","월살","공망","암록","태극귀인","복성귀인","양인살","협록"],
      ["6월","정관","甲","午","편인","건록","(사)","丙 정인","己 비견","丁 편인","재살","년살","공망","건록","원진(日)","현침살","도화살","-"],
      ["5월","편재","癸","巳","정인","제왕","(태)","戊 겁재","庚 상관","丙 정인","겁살","지살","협록","낙정관살","역마살","-","-","-"],
      ["4월","정재","壬","辰","겁재","쇠","(묘)","乙 편관","癸 편재","戊 겁재","화개살","천살","홍염살","괴강살","명예살","-","-","-"],
      ["3월","식신","辛","卯","편관","병","(절)","甲 정관","-","乙 편관","육해살","재살","문곡귀인","원진(年)","현침살","도화살","천문성","-"],
      ["2월","상관","庚","寅","정관","사","(절)","戊 겁재","丙 정인","甲 정관","역마살","겁살","천복귀인","천덕귀인","월덕귀인","역마살","-","-"],
      ["1월","비견","己","丑","비견","묘","(묘)","癸 편재","辛 식신","己 비견","반안살","화개살","태극귀인","비인살","명예살","-","-","-"]
    ]
  },
  wolun2: {
    data: [
      ["12월","정재","壬","子","편재","절","(제왕)","壬 정재","-","癸 편재","장성살","육해살","천을귀인","도화살","-","-","-","-"],
      ["11월","식신","辛","亥","정재","태","(목욕)","戊 겁재","甲 정관","壬 정재","망신살","역마살","관귀학관","현침살","고란살","역마살","천문성","-"],
      ["10월","상관","庚","戌","겁재","양","(쇠)","辛 식신","丁 편인","戊 겁재","월살","반안살","태극귀인","천덕귀인","월덕귀인","괴강살","천문성","명예살"],
      ["9월","비견","己","酉","식신","장생","(장생)","庚 상관","-","辛 식신","년살","장성살","문창귀인","천주귀인","학당귀인","도화살","-","-"],
      ["8월","겁재","戊","申","상관","목욕","(병)","戊 겁재","壬 정재","庚 상관","지살","망신살","천을귀인","금여","현침살","고란살","역마살","-"],
      ["7월","편인","丁","未","비견","관대","(관대)","丁 편인","乙 편관","己 비견","천살","월살","공망","암록","태극귀인","복성귀인","양인살","협록"],
      ["6월","정인","丙","午","편인","건록","(제왕)","丙 정인","己 비견","丁 편인","재살","년살","공망","건록","원진(日)","현침살","도화살","-"],
      ["5월","편관","乙","巳","정인","제왕","(목욕)","戊 겁재","庚 상관","丙 정인","겁살","지살","협록","낙정관살","고란살","역마살","-","-"],
      ["4월","정관","甲","辰","겁재","쇠","(쇠)","乙 편관","癸 편재","戊 겁재","화개살","천살","홍염살","현침살","백호살","명예살","-","-"],
      ["3월","편재","癸","卯","편관","병","(장생)","甲 정관","-","乙 편관","육해살","재살","문곡귀인","원진(Year)","현침살","도화살","천문성","-"],
      ["2월","정재","壬","寅","정관","사","(병)","戊 겁재","丙 정인","甲 정관","역마살","겁살","천복귀인","역마살","-","-","-","-"],
      ["1월","식신","辛","丑","비견","묘","(양)","癸 편재","辛 식신","己 비견","반안살","화개살","태극귀인","비인살","현침살","명예살","-","-"]
    ]
  }
};
